...
echo 'Hash Verify : '.$result.'<br />'
echo 'Status : '.$gatwayIpnData['status'].'<br />';
echo 'Transaction Date : '. $gatwayIpnData['tran_date'].'<br />';
echo 'Transaction ID : '. $gatwayIpnData['tran_id'].'<br />';
echo 'Validation ID : '. $gatwayIpnData['val_id'].'<br />';
echo 'Amount : '. $gatwayIpnData['amount'].'<br />';
echo 'Currency : '. $gatwayIpnData['currency'].'<br />';
echo 'Store Amount : '. $gatwayIpnData['store_amount'].'<br />';
echo 'Bank Tran_id : '. $gatwayIpnData['bank_tran_id'].'<br />';
echo 'Card Type : '. $gatwayIpnData['card_type'].'<br />';
echo 'Card No : '. $gatwayIpnData['card_no'].'<br />';
echo 'Card Issuer : '. $gatwayIpnData['card_issuer'].'<br />';
echo 'Card Brand : '. $gatwayIpnData['card_brand'].'<br />';
echo 'Card Issuer Country : '. $gatwayIpnData['card_issuer_country'].'<br />';
echo 'Card Issuer Country Code : '. $gatwayIpnData['card_issuer_country_code'].'<br />';
echo 'Store Id : '. $gatwayIpnData['store_id'].'<br />';
echo 'Verify Sign : '. $gatwayIpnData['verify_sign'].'<br />';
echo 'Verify Key : '. $gatwayIpnData['verify_key'].'<br />';
}
	}
